...
\begin{proof}
	...
	\end{enumerate}
\end{proof}
\begin{kor}[Schwacher Nullstellensatz]
...
\begin{lem} \label{lem:8.5}
	...
	\begin{enumerate}
		\item $Z(\sum I_{\nu}) = \bigcap Z(I_{\nu})$ und \label{lem:8.5:i}
		\item $Z(I\cdot J) = Z(I\cap J) = Z(I)\cup Z(J)$. \label{lem:8.5:ii}
	\end{enumerate}
\end{lem}
\begin{proof}
	\leavevmode
	\begin{enumerate}[label=\ref{lem:8.5:\roman*}]
...
\begin{defi}
	...
	\begin{enumerate}
		\item $X$ heißt \emph{irreduzibel}, falls für alle abgeschlossenen $Y_1, Y_2\subset X$ dann $Y_1\cup Y_1\subset X$ folgt.
...
\begin{defi}
	...
	\[I(Y) := \set{f+k[t_1,\dots, t_n]\given \forall x\in Y: f(x) = 0}.\]
\end{defi}
\begin{beme}
	\leavevmode
	\begin{enumerate} 
