...
\begin{prop} \label{prop:5.8}
	...
	\begin{eqnarray*}
		...
		\frac as \tp x\right &\longmapsto& \frac{ax}s.
	\end{eqnarray*}
\end{prop}
\begin{proof}
...
\begin{proof}
	...
	\begin{description}
		...
		\item[\ref{thm:lokal-global-injsur:ii} $\Rightarrow$ \ref{thm:lokal-global-injsur:iii}:] Klar. \label{thm:lokal-global-injsur:i}
