...
\begin{satz}[Noether-Normalisierung]
	Sei $k$ ein Körper, sei $A$ endlich erzeugte $k$-Algebra. Seien $I_1\subseteq \dots \subseteq I_m\subsetneq A$ Ideale. Dann exsitert $n\geq 0$ und $a_1,\dots, a_n\in A$ sowie $0\leq h_1\leq\dots \leq d_m\leq n$ sodass 
	\begin{enumerate}
