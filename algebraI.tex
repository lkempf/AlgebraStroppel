...
\begin{proof}
	...
	Dabei ist $(\fp A_{\fp})\cdot B_{\fp} = \fp B_{\fp}$, folgich haben wir eine 1:1-Korrespondenz zu
...
\begin{bsp}
	...
	\end{eqnarray*}
	Folglich: $s$ teilt $r^n$; damit ist $s\in \IZ^{times}$ und $x\in\IZ$.
\end{bsp}
