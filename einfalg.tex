...
\begin{satz}[Satz 5.2 (Bahnenformel)]
...
\begin{satz}[Satz 6.3 (Sylowsätze)]
...
\begin{bsp}
	...
	\begin{proof}
		...
		$$ \overline{t ^j} = \overline{t^{j-2}(t^2+1)+(-t^{j-2})} \xeq{\text{Def von $+$ in $R/I$}} \overline{t^{j-2}(t^2+1)}+\overline{-t^{j-2}} \xeq{\text{Def von $\odot$}}$$
		$$ =  \overline{t^{j-2}}\odot \overline{t^2+1} + \overline{-t^{j-2}} = \overline{-t^{j-2}} \xeq{\text{Def von $+$ in $R/I$}} - (\overline{t^{j-2}})$$
